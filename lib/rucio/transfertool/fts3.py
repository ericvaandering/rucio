    ...
    def _file_from_transfer(self, transfer: "DirectTransfer", job_params: dict[str, str]) -> dict[str, Any]:
        ...
        if self.token:
            ...
            for source in transfer.sources:
                ...
                src_scope = determine_scope_for_rse(rse_id=source.rse.id, scopes=['storage.read'],
                                                    extra_scopes=['offline_access'], file_path=src_path)
            ...
            dst_scope = determine_scope_for_rse(transfer.dst.rse.id, scopes=['storage.modify', 'storage.read'],
                                                extra_scopes=['offline_access'], file_path=dst_path)
