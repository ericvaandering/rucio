                ...
                try:
                    ...
                    for file_replicas in chunks(replicas, 100):
                        ...
                        if not exclude_dids and not include_dids
                            filtered_replicas = file_replicas
                        else:
                            for replica in file_replicas:
                                did = replica['scope'] +':'+ replica['name']
                                if exclude_dids and did.contains(exclude_dids):
                                    continue
                                if include_dids and did.contains(include_dids):
